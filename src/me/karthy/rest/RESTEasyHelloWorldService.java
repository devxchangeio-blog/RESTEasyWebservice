...
public class RESTEasyHelloWorldService {
	...
	private static final Logger logger = Logger.getLogger(RESTEasyHelloWorldService.class);

	@GET
	@Path("getSomething/{request}")
    @Produces(MediaType.TEXT_PLAIN)
	public String getSomething(@PathParam("request") String request ,
	...
	@Path("/postSomething")
    @Produces(MediaType.TEXT_PLAIN)
	public String postSomething(@FormParam("input") String request ,  @DefaultValue("1") @FormParam("version") int version) {
